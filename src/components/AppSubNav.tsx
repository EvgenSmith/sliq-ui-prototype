...
const POOLS_TABS: SubTab[] = [
  { to: '/lp/listings', label: 'My listings', match: p => p === '/lp/listings' || p.startsWith('/lp/listings/') },
  { to: '/lp/deposit', label: 'Deposit', match: p => p === '/lp/deposit' },
  { to: '/lp/claims', label: 'Claims', match: p => p === '/lp/claims' },
]
